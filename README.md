...
For a standalone clone, use the `vs2022-x64` preset. It fetches the pinned MWFL `v0.1.0` release plus Scintilla/Lexilla, WebView2 SDK, and md4c sources. The WebView2 Runtime must be installed on the machine for preview; Windows 11 normally includes it.
