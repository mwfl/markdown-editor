...
For a standalone clone, use the `vs2022-x64` preset. It fetches the pinned mwfl v0.1.2, Scintilla/Lexilla, WebView2 SDK, and md4c sources. The WebView2 Runtime must be installed on the machine for preview; Windows 11 normally includes it.
